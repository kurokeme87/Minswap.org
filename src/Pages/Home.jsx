      ...
      <div className="max-w-screen-2xl m-auto">
        ...
        <div className="max-w-screen-xl m-auto px-5 pt-2 sm:px-3 flex flex-col md:flex-row">
          <div className="p-5 rounded-xl bg-[#232a3d] w-[100%] md:mx-2 max-h-[400px]">
            ...
            <div>
              <Link to='https://minswap-labs.medium.com' target="_blank" className="bg-[#8aaaff] hover:bg-textSecondary duration-100 rounded-full font-medium px-5 py-3">
                Read our blog
              </Link>
            </div>
          </div>
          <div className="p-5 rounded-xl bg-[#232a3d] w-[100%] md:mx-2 mt-3 sm:mt-0 max-h-[400px]">
            ...
            <div className="flex gap-1.5 sm:gap-3 mt-4 w-[100%]">
              <Link to='https://x.com/MinswapDEX' target="_blank" className="bg-[#050b19] p-2 sm:p-3 rounded-2xl">
                <svg
                  fill="none"
                  height="36"
                  viewBox="0 0 36 36"
              ...
              <Link to='https://discord.com/invite/minswap' target="_blank" className="bg-[#bfc0e9] p-2 sm:p-3 rounded-2xl">
                <svg
                  fill="none"
                  height="16"
                  viewBox="0 0 22 16"
              ...
              <Link to='https://www.reddit.com/r/MinSwap/' target="_blank" className="bg-[#fe996d] p-2 sm:p-3 rounded-2xl">
                <svg
                  fill="none"
                  height="22"
                  viewBox="0 0 22 22"
              ...
              <Link to='https://t.me/MinswapMafia' target="_blank" className="bg-[#a1d6fe] p-2 sm:p-3 rounded-2xl">
                <svg
                  height="24"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <Link to='https://github.com/minswap' target="_blank" className="bg-[#313746] p-2 sm:p-3 rounded-2xl">
                <svg
                  fill="none"
                  height="22"
                  viewBox="0 0 22 22"
